...
from ..services.reports.csv.csv_generator import generate_all_insights_csv, generate_collapsed_insights_csv
...
def download_summary_insights_data():
    try:
        return generate_collapsed_insights_csv()
    except Exception as e:
        return render_template('errors/error404.html', error=str(e)), 404
