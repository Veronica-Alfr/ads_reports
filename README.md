...
## 👉 Com Docker
    ...
    ⚠ Antes de começar, saiba que o docker-compose usado nesse projeto foi na versão 1.29.2 e o docker na versão 27.5.1, portanto são as versões indicadas para rodar o projeto.

    ℹ️ Suba o projeto completo usando o comando docker-compose up --build na raiz do projeto.

    - Esses serviços inicializarão o contêiner chamado ads_reports_web_1.
...
## 👉 Sem Docker
    ...
    ℹ Crie um ambiente virtual no Linux com o comando `python -m venv nome_do_ambiente`, e depois o ative rodando o comando `source nome_do_ambiente/bin/activate`.

    ℹ Instale as dependências com `pip install -r requirements.txt`.

    ℹ Em seguida para rodar a aplicação use o comando `python run.py`.

    ⚠ A versão do python usada nesse projeto é a 3.11.10, portanto é a mais indicada.
  ...
  <p>As tecnologias usadas foram: Python, Flask, Docker, CSS e HTML.</p>
